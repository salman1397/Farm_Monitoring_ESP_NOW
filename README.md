...
## 📡 Working Principle
1️⃣ **ESP32 Sensor Nodes** collect environmental data (Temperature, Humidity, Soil Moisture).  
2️⃣ **ESP-NOW Protocol** transmits data wirelessly to the **ESP32 Gateway**.  
3️⃣ **ESP32 Gateway** processes and uploads the data to a local dashboard.  
4️⃣ Farmers access real-time farm data via **dashboard**.  
